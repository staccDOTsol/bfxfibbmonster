                    ...
                    for (var d in doc3) {
                        ...
                        if (doc3[d].trades) {
                            ...
                            if (doc3[d].trades.bought1 == false) {
                                var sl = {
                                    'activeOrders': activeOrders[doc3[d].trades.k],
                                    'direction': 'buy1',
                                    'pair': doc3[d].trades.k,
                                    'stoplimit': doc3[d].trades.buy1,
                                    'currentAsk': bestAsk[doc3[d].trades.k],
                                    'percent': (parseFloat(bestAsk[doc3[d].trades.k]) / parseFloat(doc3[d].trades.buy1))
                                }
                            ...
                            if (doc3[d].trades.bought2 == false) {
                                if (doc3[d].trades.buy2 != undefined) {
                                    ...
                                    var sl = {
                                        ...
                                        'direction': 'buy2',
                                        'pair': doc3[d].trades.k,
                                        'stoplimit': doc3[d].trades.buy2,
                                        'currentAsk': bestAsk[doc3[d].trades.k],
                                        'percent': (parseFloat(bestAsk[doc3[d].trades.k]) / parseFloat(doc3[d].trades.buy2))
                                    }
                            ...
                            if (doc3[d].trades.sold1 == false) {
                                var sl = {
                                    ...
                                    'direction': 'sell1',
                                    'pair': doc3[d].trades.k,
                                    'stoplimit': doc3[d].trades.sell1,
                                    'currentBid': bestBid[doc3[d].trades.k],
                                    'percent': (parseFloat(doc3[d].trades.sell1 / parseFloat(bestBid[doc3[d].trades.k])))
                                }
                                if ((activeOrders[doc3[d].trades.k] <= 1) && tickers.includes('trade:1m:' + doc3[d].trades.k)) {
                                    stoplimits.push(sl);
                            ...
                            if (doc3[d].trades.sold2 == false) {
                                if (doc3[d].trades.sell2 != undefined) {
                                    ...
                                    var sl = {
                                        ...
                                        'direction': 'sell2',
                                        'pair': doc3[d].trades.k,
                                        'stoplimit': doc3[d].trades.sell2,
                                        'currentBid': bestBid[doc3[d].trades.k],
                                        'percent': (parseFloat(doc3[d].trades.sell2) / parseFloat(bestBid[doc3[d].trades.k]))
                                    }
            ...
            setTimeout(async function() {
                ...
                for (var o in orders2) {
                    if (!osymbols.includes(orders2[o].symbol)) {
                        ...
                        if (symbolcounts[string] == undefined) {
                            symbolcounts[string] = 0;
                        }
                        symbolcounts[string] = symbolcounts[string] + parseFloat(orders2[o].amount);
                ...
                for (let i = 0; i < positions.length; i += 1) {
                    ...
                    console.log(p);
                    var string2 = p[0];
                    if (poscounts[string2] == undefined) {
                        poscounts[string2] = 0;
                    }
                    var amount = p[2]
                ...
                for (var s in poscounts) {
                    if (!osymbols.includes(s)) {
                        ...
                        rest.symbols().then(symbols => {
                            ...
                            rest.tickers([symbols.map(s => `t${s.toUpperCase()}`)])
                        }).then(tickers => {
                            let t
                ...
                if (gosend == true) {
                    ...
                    res.send('<head><link rel="icon" href="https://polofibbmonster.herokuapp.com/favicon.ico?v=2" /><meta http-equiv="refresh" content="120"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script></head><h1>Don\'t Panic! If the data seems off, wait a minute or so.</h1>' +
                        ...
                        '<div style="display:none;" id="lalapositions">' + JSON.stringify(lalapositions) + '</div>' +
                        ...
                        '<div id="showData5"></div><div id="showData6"></div><div id="showData7"></div>' +
                        '<br>open positions: (' + lalapositions.length + ')' + '<div id="showPositions"></div><br>stoplimits:' +
